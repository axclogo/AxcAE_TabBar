//
//  WHGradientHelperGradientItemTabBarVC.m
//  AxcAE_TabBar
//
...
#import "WHGradientHelperGradientItemTabBarVC.h"
#import "WHGradientHelper.h"

@interface WHGradientHelperGradientItemTabBarVC ()<AxcAE_TabBarDelegate>

@end

@implementation WHGradientHelperGradientItemTabBarVC
...
- (void)addChildViewControllers{
    ...
    [VCArray enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        model.normalColor = [UIColor orangeColor];
    ...
    // DEMO 混合使用渐变色工具
    /******************************************************************************/
    self.axcTabBar.backgroundImageView.image = [WHGradientHelper getLinearGradientImage:[UIColor orangeColor]
...
- (void)axcAE_TabBar:(AxcAE_TabBar *)tabbar selectIndex:(NSInteger)index{
    ...
    [self click_itemWithIndex:index];
}
- (void)click_itemWithIndex:(NSInteger )index{
    /******************************************************************************/
    [self.axcTabBar.tabBarItems enumerateObjectsUsingBlock:^(AxcAE_TabBarItem * _Nonnull item, NSUInteger idx, BOOL * _Nonnull stop) {
        if (index == idx) { // 当前触发的
