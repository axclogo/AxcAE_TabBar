...
#import "WHGradientHelperGradientTabBarVC.h"
#import "WHGradientHelper.h"

@interface WHGradientHelperGradientTabBarVC ()<AxcAE_TabBarDelegate>

@end

@implementation WHGradientHelperGradientTabBarVC
...
- (void)addChildViewControllers{
    ...
    [VCArray enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        model.selectTintColor = [UIColor blackColor];
        model.selectBackgroundColor = [UIColor colorWithWhite:1 alpha:0.3];
    ...
    // DEMO 混合使用渐变色工具
    /******************************************************************************/
    self.axcTabBar.backgroundImageView.image = [WHGradientHelper getLinearGradientImage:[UIColor blackColor]
                                                                                    and:[UIColor grayColor]
