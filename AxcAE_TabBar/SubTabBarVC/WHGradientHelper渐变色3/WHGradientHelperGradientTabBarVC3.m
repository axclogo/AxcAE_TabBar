...
@interface WHGradientHelperGradientTabBarVC3 ()<AxcAE_TabBarDelegate>
...
- (void)addChildViewControllers{
    ...
    [VCArray enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        model.normalColor = AxcAE_TabBarRGB(65, 29, 53);
        
        model.selectTintColor = [UIColor whiteColor];
        model.normalTintColor = AxcAE_TabBarRGB(65, 29, 53);
        ...
        switch (idx) {
            ...
            case 1:
            case 3:
                model.selectBackgroundColor =  AxcAE_TabBarRGB(190, 45, 55);
                break;
            case 2:
                model.selectBackgroundColor = AxcAE_TabBarRGB(194, 109, 119);
                break;
            case 4:
    ...
    // DEMO 混合使用渐变色工具
    /******************************************************************************/
    self.axcTabBar.backgroundImageView.image = [WHGradientHelper getLinearGradientImage:[UIColor redColor]
