...
#import "ItemSizeTabBarVC.h"

@interface ItemSizeTabBarVC ()<AxcAE_TabBarDelegate>

@end

@implementation ItemSizeTabBarVC
...
- (void)addChildViewControllers{
    ...
    // DEMO 自定设置大小的数组
    NSArray <NSValue *>*itemSizeArray = @[[NSValue valueWithCGSize:CGSizeMake(30, 40)],    // 第1个TabBarItem大小
                                          [NSValue valueWithCGSize:CGSizeMake(40, 40)],    // 第2个TabBarItem大小
                                          [NSValue valueWithCGSize:CGSizeMake(50, 40)],    // 第3个TabBarItem大小
                                          [NSValue valueWithCGSize:CGSizeMake(60, 40)],    // 第4个TabBarItem大小
                                          [NSValue valueWithCGSize:CGSizeMake(70, 40)]];   // 第5个TabBarItem大小
    // 1.遍历这个集合
    // 1.1 设置一个保存构造器的数组
    ...
    [VCArray enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        // DEMO 设置大小
        /******************************************************************************/
        model.itemSize = [itemSizeArray[idx] CGSizeValue];
        // 为了方便观察设置背景颜色
