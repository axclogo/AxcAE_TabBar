...
@interface ItemSizeAlignmentTabBarVC ()<AxcAE_TabBarDelegate>
...
- (void)addChildViewControllers{
     ...
     */
    // 只有设置了按钮大小才能进行布局
    NSArray *customLayoutArray = @[@(AxcAE_TabBarConfigAlignmentStyleCenterTop),    // 居中顶部对齐
                                   @(AxcAE_TabBarConfigAlignmentStyleCenterLeft),   // 居中靠左
                                   @(AxcAE_TabBarConfigAlignmentStyleCenterRight),  // 居中靠右
                                   @(AxcAE_TabBarConfigAlignmentStyleCenterBottom), // 居中靠底
                                   @(AxcAE_TabBarConfigAlignmentStyleTopLeft)];     // 上左对齐
