...
@interface ItemCustomBadgeTabBarVC ()<AxcAE_TabBarDelegate>
...
- (void)addChildViewControllers{
     ...
     */
    NSArray *customBadgeArray = @[@(AxcAE_TabBarItemBadgeStyleTopRight),     // 右上方 默认
                                  @(AxcAE_TabBarItemBadgeStyleTopRight),     // 右上方 默认
                                  @(AxcAE_TabBarItemBadgeStyleTopCenter),   // 上中间
                                  @(AxcAE_TabBarItemBadgeStyleTopLeft),     // 左上方
                                  @(AxcAE_TabBarItemBadgeStyleTopLeft)];     // 左上方
