...
#import "ItemBackgroundImageTabBarVC.h"

@interface ItemBackgroundImageTabBarVC ()<AxcAE_TabBarDelegate>

@end

@implementation ItemBackgroundImageTabBarVC
