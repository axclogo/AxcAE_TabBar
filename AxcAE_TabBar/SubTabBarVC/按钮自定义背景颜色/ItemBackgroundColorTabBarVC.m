...
#import "ItemBackgroundColorTabBarVC.h"

@interface ItemBackgroundColorTabBarVC ()<AxcAE_TabBarDelegate>

@end

@implementation ItemBackgroundColorTabBarVC
...
- (void)addChildViewControllers{
    ...
    // 选中后背景颜色的数组
    NSArray <UIColor *>*selectBackgroundColors = @[[UIColor lightGrayColor],
                                                   [UIColor orangeColor],
                                                   [UIColor greenColor],
                                                   [UIColor redColor],
                                                   [UIColor purpleColor]];
    ...
    [VCArray enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        // DEMO 设置选中的背景颜色
        /******************************************************************************/
        model.selectBackgroundColor = selectBackgroundColors[idx];
        /******************************************************************************/
