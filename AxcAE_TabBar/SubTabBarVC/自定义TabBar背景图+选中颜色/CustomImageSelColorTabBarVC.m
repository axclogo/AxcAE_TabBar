...
#import "CustomImageSelColorTabBarVC.h"

@interface CustomImageSelColorTabBarVC ()<AxcAE_TabBarDelegate>

@end

@implementation CustomImageSelColorTabBarVC
