...
@interface WeiBoTabBarVC ()<AxcAE_TabBarDelegate>
...
- (void)addChildViewControllers{
    ...
    @[@{@"vc":[UIViewController new],@"normalImg":@"WeiBo",@"selectImg":@"WeiBo_",@"itemTitle":@"微博"},
      @{@"vc":[UIViewController new],@"normalImg":@"Msg",@"selectImg":@"Msg_",@"itemTitle":@"消息"},
      @{@"vc":[UIViewController new],@"normalImg":@"",@"selectImg":@"",@"itemTitle":@" "},
      @{@"vc":[UIViewController new],@"normalImg":@"Find",@"selectImg":@"Find_",@"itemTitle":@"发现"},
      @{@"vc":[UIViewController new],@"normalImg":@"Me",@"selectImg":@"Me_",@"itemTitle":@"我"}];
    // 1.遍历这个集合
    // 1.1 设置一个保存构造器的数组
